...
const config: Record<string, any> = {
  ...
  ODYSEE_ANALYTICS_TRACKING_KEY: process.env.ODYSEE_ANALYTICS_TRACKING_KEY,
  ...
  HOMEPAGE_LOCAL_CONTENT: process.env.HOMEPAGE_LOCAL_CONTENT === 'true',
  SHOW_TAGS_INTRO: process.env.SHOW_TAGS_INTRO === 'true',
  SEARCH_DEFAULT_TYPES: process.env.SEARCH_DEFAULT_TYPES,
...
export const {
  ...
  HYPERBEAM_BASE_URL,
  HYPERBEAM_ALLOW_COMPATIBILITY_READS,
  SITE_TITLE,
  SITE_NAME,
  SITE_DESCRIPTION,
  SITE_HELP_EMAIL,
