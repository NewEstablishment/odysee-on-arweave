...
const config = {
  ...
  HYPERBEAM_MULTIREQUEST_MODULE_ID: process.env.HYPERBEAM_MULTIREQUEST_MODULE_ID,
  HOMEPAGE_HYPERBEAM_AUTH_TOKEN: process.env.HOMEPAGE_HYPERBEAM_AUTH_TOKEN,
  HOMEPAGE_SNAPSHOT_COMMITTER: process.env.HOMEPAGE_SNAPSHOT_COMMITTER,
  HOMEPAGE_SNAPSHOT_LOOKBACK_HOURS: process.env.HOMEPAGE_SNAPSHOT_LOOKBACK_HOURS,
  ...
  HYPERBEAM_ALLOW_COMPATIBILITY_READS: process.env.HYPERBEAM_ALLOW_COMPATIBILITY_READS !== 'false',
