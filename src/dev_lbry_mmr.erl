...
%%% Leaves are block hashes (`sha256d(header)'), interior nodes are
%%% `sha256d(L || R)', peaks are bagged right-to-left, and a chunk is the
%%% height-10 perfect subtree over exactly 1024 block hashes. These
%%% constructions are byte-validated against mainnet.
%%%
